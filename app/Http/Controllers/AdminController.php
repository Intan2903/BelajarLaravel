...
class AdminController extends Controller
{
    ...
    public function postTambahAdmin(Request $request)
    {
        $request->validate([
            ...
            // Perbaikan pada validasi password
            'email' => 'required|email|unique:users,email',
            // Perbaikan pada validasi email
        ]);
    ...
    public function postEditBerita(Request $request, $id)
    {
        ...
        if ($request->hasFile('foto')) {
            $request->validate([
                'foto' => 'image|max:5120',
                // Gambar harus berupa gambar dan ukuran maksimum 5MB
            ]);
            ...
            $oldFilePath = public_path('images/') . $Berita->foto;
