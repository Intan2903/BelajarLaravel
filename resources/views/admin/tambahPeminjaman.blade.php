                ...
                <div class="card mt-4" style="width: 800px">
                    <div class="card-body">
                        <h5 class="card-title text-center">Tambah
                            Data</h5>
                        <form action="{{ route('postTambahPeminjaman')
}}" method="POST">
                            @csrf
                            <div class="form-group mt-4">
                                <label class="text-secondary mb-2">Nomor
                                    Anggota</label>
                                <input type="text" class="form-control
border border-secondary form-control" name="idUser" required value="{{
old('idUser') }}">
...
border border-secondary form-control" name="tanggalPeminjaman" required value="{{ old('tanggalPeminjaman') }}">
                                <span class="text-danger">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="date" class="form-control
border border-secondary form-control" name="tanggalPengembalian" required value="{{ old('tanggalPengembalian') }}">
                                <span class="text-danger">
...
mt-5">Tambah Data Peminjaman</button>
                        </form>
                    </div>
                </div>
            </div>
