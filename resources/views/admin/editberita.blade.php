...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">
    <title>Update Data Berita</title> </head>
...
<body> <nav class="navbar navbar-dark bg-primary">
    ...
    </nav> <div class="container mt-3"> <!-- Tampilkan pesan sukses jika ada -->
    ...
    <div class="container mt-4">
        ...
        </div> <div class="container mt-4"> <div class="card" style="width: 800px">
        <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control border border-secondary form-control" name="judul" required
                value="{{ $data->judul }}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control border border-secondary form-control" name="deskripsi" required
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="isi" style="height: 250px" required>{{ $data->isi }}</textarea>
        </div>
        <!-- form gambar berita -->
        <div class="form-group">
