                        ...
                        <form action="{{ route('postTambahBerita') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <textarea class="form-control" name="deskripsi"
                                    placeholder="Tulis isi berita disini...." style="height: 250px" required
                            ...
                            <div class="form-group mt-1">
                                ...
                                <textarea class="form-control" name="isi" placeholder="Tulis isi berita disini...."
                                    style="height: 250px" required value="{{ old('isi') }}"></textarea>
                                <span class="text-danger">
                                    @error('isi')
                                    {{ $message }}
                                    @enderror
