...
border-secondary form-control" name="name" required value="{{ old('name') }}">
...
border border-secondary form-control" name="password" required>
                                <span class="text-danger">
                                    @error('password')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="password" class="form-control 
border border-secondary form-control" name="password_confirmation" required>
                                <span class="text-danger">
