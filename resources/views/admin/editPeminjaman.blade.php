            ...
            <div class="col d-flex justify-content-center">
                <div class="card mt-4" style="width: 800px">
                    <div class="card-body">
                        ...
                        <form action="/postEditPeminjaman/{{ $data->id
}}" method="POST">
                            @csrf
...
$data->id_buku }}">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control
border border-secondary form-control" name="tanggalPeminjaman" required value="{{ $data->tanggal_pinjam }}">
                                <span class="text-danger">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control
border border-secondary form-control" name="tanggalPengembalian" required value="{{ $data->tanggal_kembali }}">
                                <span class="text-danger">
...
mt-5">Update Data Peminjaman</button>
                        </form>
                    </div>
                </div>
            </div>
