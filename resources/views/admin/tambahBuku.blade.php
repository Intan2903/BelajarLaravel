...
border border-secondary form-control" name="kodeBuku" required value="{{
old('kodeBuku') }}">
                            ...
                            <div class="form-group mt-1">
                                <label class="text-secondary mb-2">Judul
                                    Buku</label>
                                <input type="text" class="form-control
border border-secondary form-control" name="judulBuku" required value="{{
old('judulBuku') }}">
                                <span class="text-danger">
                                    @error('judulBuku')
                                    {{ $message }}
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control
border border-secondary form-control" name="penulis" required value="{{
old('penulis') }}">
                                <span class="text-danger">
                                    @error('penulis')
                                    {{ $message }}
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control
border border-secondary form-control" name="penerbit" required value="{{
old('penerbit') }}">
                                <span class="text-danger">
                                    @error('penerbit')
                                    {{ $message }}
...
border border-secondary form-control" name="tahunTerbit" required value="{{
old('tahunTerbit') }}">
                                <span class="text-danger">
                                    @error('tahunTerbit')
                                    {{ $message }}
                            ...
                            <div class="form-group mt-1">
                                <label class="text-secondary mb-2">Kategori
                                    Buku</label>
                                <select class="form-select" arialabel="Floating label select example" name="kategori">
                            ...
                            <div class="form-group mt-1">
                                <label class="text-secondary mb2">Comments</label>
                                <textarea class="form-control" name="deskripsi"
                                    placeholder="Tulis deskripsi buku disini...." style="height: 250px" required value="{{ old('deskripsi')
}}"></textarea>
                            </div>
