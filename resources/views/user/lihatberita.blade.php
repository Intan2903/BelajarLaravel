...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark shadow-sm fixed-top" style="background-color: #94AF9F;?">div
        class="container "> <a class="navbar-brand mr-auto" href="/">Politeknik Negeri Bengkalis | DIV Rekayasa
            Perangkat Lunak</a>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="row">
                        <div class="col-2"> <img style="width: 50px" src="{{ asset('images/' . $Berita->foto) }}"
                                alt="cover Berita"></div>
                        <div class="col-2">
