...
<head>
    ...
    <style>
    /* CSS kustom untuk mengatur dua kolom */
    .dual-column {
        display: flex;
    }
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <img src="/image/berita1.jpeg" class="card-img-top" alt="Gambar Berita 1">
                    <div class="card-body">
                        <h5 class="card-title">Jalan Santai Dan Penanaman Pohon, Jadi Peringatan Puncak Milad Polbeng
                            Ke-22</h5>
                        <p class="card-text">
                            <!-- Konten Berita 1 (Kiri) -->
                        </p>
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <img src="/image/berita2.jpeg" class="card-img-top" alt="Gambar Berita 2">
                    <div class="card-body">
                        <h5 class="card-title">Polbeng Terima Bantuan Beasiswa Pendidikan Dari Provinsi Riau</h5>
                        <p class="card-text">
                            <!-- Konten Berita 2 (Kanan) -->
                        </p>
                        <a href="#" class="btn btn-primary">Baca Selengkapnya</a>
                    </div>
                </div>
